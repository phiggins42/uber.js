(function(global, define){
    ...
    function(has, dom, array, object, Deferred){
        ...
        var domReady = typeof require != "undefined" && require.ready && require.s ? (function(){
            var domReady = new Deferred,
                oldCallReady = require.callReady;
            ...
            var checkDOMReady = function(evt){
                ...
                }else if((evt && evt.type == "DOMContentLoaded") ||
                        documentReadyStates[document.readyState]){
                    onDOMReady();
                }
            };
            function poller(){
    ...
    this.uber_dom_event = factory(has, uber_dom, uber_array, uber_object, uber_Deferred); // use global has and uber_*
});
