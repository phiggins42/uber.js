(function(global, define){
    define(["has/events", "uber/dom", "uber/object", "uber/promise", "uber/deferred"],
    function(has, dom, object, prms, defd){
        if(!has("dom")){ return {}; }
        ...
        var domReady = typeof require != "undefined" && require.ready ? (function(){
            var domReady = new defd.Deferred();
        ...
        (function(){
            ...
            function unloadDeferred(eventName){
                var attached = 0, deferred = new defd.Deferred(),
                    op = deferred.promise,
                    promise = new prms.Promise(),
                    then, cancel;
    ...
    this.uber_dom_event = factory(has, uber_dom, uber_object, uber_promise, uber_deferred); // use global has and uber_*
});
