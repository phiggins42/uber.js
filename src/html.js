(function(uber, has, document){
    ...
    var isDescendant = uber.getDescendant = function isDescendant(node, ancestor){
        try{
            while(node){
                if(node === ancestor){
                    return true;
    ...
    var gcs = uber.getComputedStyle = (function(){
        var getComputedStyle;
        if(has("dom-current-style")){
            gcs = function getComputedStyle(node){
    ...
    var getStyleProperty = uber.getStyleProperty = (function(){
    ...
    var setSelectable = uber.setSelectable = (function(){
